...
export default function TeamPage({
  ...
  const teamName =
    decodeURIComponent(params.team)
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <Link
        href="/classificacao"
        className="inline-flex mb-8 text-zinc-400 hover:text-white"
      >
        ← Voltar
      </Link>
      ...
      <div className="bg-gradient-to-br from-red-950/20 to-black border border-zinc-800 rounded-3xl p-10 mb-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-black/50 border border-zinc-800 rounded-2xl p-6 text-center">
